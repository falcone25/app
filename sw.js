const CACHE='peacefeed-v03-20260819';
const SHELL=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./data/cards.json'];
...
self.addEventListener('fetch',event=>{
  ...
  const isContent=url.pathname.endsWith('/data/cards.json')||url.pathname.endsWith('/data/review.json');
  if(isContent){
